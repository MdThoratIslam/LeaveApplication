...
{
    togglemenu();
    if($("body").hasClass("layout-6")||$("body").hasClass("layout-7")){togglemenulayout()}menuhrres();
    ...
    $(".mobile-menu").on("click",function(){var c=$(this);
        c.toggleClass("on")});$("#mobile-collapse").on("click",function(){if(b>991){$(".pcoded-navbar:not(.theme-horizontal)").toggleClass("navbar-collapsed")}});
        $(".mob-toggler").on("click",function(){$(".pcoded-header > .collapse,.pcoded-header > .container > .collapse").toggleClass("d-flex")});$(".search-btn").on("click",function(){var c=$(this);
            $(".main-search").addClass("open");
            if(b<=991){$(".main-search .form-control").css({width:"90px"})}else{$(".main-search .form-control").css({width:"150px"})}});
    $(".search-close").on("click",function(){var c=$(this);$(".main-search").removeClass("open");
